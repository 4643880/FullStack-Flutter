// Have to requeire validator package
...
const myAizazDataSchema = new mongoose.Schema({
    ...
    // Validator pkg ko require karna zaroori ha
    email: {
        type: String,
        require : true,
        unique: true,
    ...
    type: {
        ...
        message: 'You can select only frontend and backend'
        }
    },
    active: Boolean,
    videos: {
        ...
        validate(value){
            if(value < 0){
                throw new Error('Your value is less than zero');
            }
        }
        // validate: {
